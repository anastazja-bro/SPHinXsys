...
* @brief 	This is the method of splitting parameter for reverse or optimization problem.
...
namespace SPH
{
	...
	/**
	  ...
	  * @brief Modify the parameter inner by splitting operator based on PDE equation.
	  */
	...
	/**
	  ...
	  * @brief Modify the parameter contact with boundary by splitting operator based on PDE equation.
	  */
